# AWS DeepRacer Webserver Package for Traffic Simulation  project
...
| /traffic_navigation_pkg/set_max_speed | SetMaxSpeedSrv | Client to set Traffic Simulation max speed percentage scale value during Traffic Simulation navigation. |
