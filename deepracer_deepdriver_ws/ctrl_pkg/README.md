# AWS DeepRacer Control Package for DeepDriver project
...
| /deepdriver_navigation_pkg/deepdriver_drive | ServoCtrlMsg | Message with steering angle and throttle data sent to the servo package to move the car in deepdriver mode. |
