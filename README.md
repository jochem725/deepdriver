# AWS DeepRacer Traffic Simulation Project
...
To launch the Traffic Simulation sample application as root user on the AWS DeepRacer device open up another terminal on the device and run the following commands as root user:
